...
if __name__ == '__main__':
    ...
    pretrain_methods = ['SimCLR', 'BYOL', 'SwAV']
    shots = ['5', '8']
    rds = ['0.9', '0.95']
    epochs = ['60']
    batch_sizes = ['512']
                    ...
                    for batch_size in batch_sizes:
                        for rd in rds:
                            for shot in shots:
                                ...
                                with open('out/{}_{}_{}_eps_{}_bs_{}_rd_{}_{}shot.out'.format(dataset, pretrain_method, arch, epoch, batch_size, rd, shot), 'w') as f:
                                    base_list = ['bash', 'scripts/bsearch_finetune_search_continue_channel_wise.sh', launch_id, shot, dataset, arch, pretrain_method, rd, epoch, batch_size]
