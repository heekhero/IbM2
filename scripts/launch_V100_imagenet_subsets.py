                    ...
                    for pre_epoch in pre_epochs:
                        for rd in rds:
                            for right in rights:
                                ...
                                with open('out/imagenet_subsets_{}_{}_pre_epochs_{}_final_epochs_{}_bs_search_{}_bs_train_{}_rd_{}_{}pt_right_{}.out'.format(pretrain_method, arch, pre_epoch, final_epoch, batch_size_search, batch_size_train, rd, pt, right), 'w') as f:
                                    base_list = ['bash', 'scripts/bsearch_finetune_search_continue_channel_wise_imagenet_subsets.sh', launch_id, pt, arch, pretrain_method, rd, pre_epoch, final_epoch, batch_size_search, batch_size_train, right]
