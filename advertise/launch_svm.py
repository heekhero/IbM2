...
if __name__ == '__main__':
    ...
    for arch in archs:
        for shot in shots:
            for aug100times in [True]:

                with open('out/svm/linear_svc_{}_{}shot_aug_{}.out'.format(arch, shot, aug100times), 'w') as f:
                    base_list = ['python', 'advertise/svm_svc.py', '--shot', shot, '--arch', arch]
